...
#
# example
#bash bash_paallel_function_example.sh <date after> <date before> <number of thread>

#example of using paralle computing at bash with dxtoolkits, the function part can be replace for desired function
